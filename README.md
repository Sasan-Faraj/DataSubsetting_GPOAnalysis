...
To make things easier as well, feel free to download this <a href="https://github.com/Sasan-Faraj/DataSubsetting_GPOAnalysis/tree/main/filestructuredownload" download>folder</a>, which contains an r script and preloaded data. The goal is that you can just change the file name for whatever xlsx file you want to use. You would potentially need to update the file structure as well. 
